...
class SelectedElementsStore {
    outlineStore;
    documentFilter;
    static selections = new WeakMap();
    constructor(outlineStore, documentFilter) {
        this.outlineStore = outlineStore;
        this.documentFilter = documentFilter;
    }
    didChangeSelected = new vscode.EventEmitter();
    onDidChangeSelected = this.didChangeSelected.event;
    register() {
        return [
    ...
    static filterSelectedElements(selections, elements) {
        return selections
...
exports.default = SelectedElementsStore;
//# sourceMappingURL=selectedElementsStore.js.map