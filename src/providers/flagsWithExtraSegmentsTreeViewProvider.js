...
class FlagsWithExtraSegmentsTreeViewProvider {
    outlineStore;
    ...
    async getTreeItem(element) {
        if (element instanceof vscode.Uri) {
            ...
            return new treeViewItems_1.FileTreeItem(element, String(outline?.map?.allFeatures.filter(feature => feature.hasExtraSegments).length ?? ''));
        }
        else {
...
exports.default = FlagsWithExtraSegmentsTreeViewProvider;
//# sourceMappingURL=flagsWithExtraSegmentsTreeViewProvider.js.map